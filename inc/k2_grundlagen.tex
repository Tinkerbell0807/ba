...
\begin{itemize}[leftmargin=*, nosep, before=\vspace{-0.6\baselineskip}, after=\vspace{-\baselineskip}]
	\item Eclipse-basierte grafische Modellierung und Bearbeitung für Mikroservices und Domänenmodelle.
	\item Umfassende Unterstützung für Schnittstellenmanagement, von Entwurf bis hin zu Zwischenmodellen.
	\item Automatisierte Generierung von ausführbarem Java-Code, Service-Stubs und Konfigurationen, basierend auf Spring Boot und Spring Cloud.
\end{itemize} \\
\hline
OCGI \cite{zalila} & 
\begin{itemize}[leftmargin=*, nosep, before=\vspace{-0.6\baselineskip}, after=\vspace{-\baselineskip}]
	...
	\item Ein universeller, generischer Rahmen, der OCCI-Spezifikationen ergänzt und in verschiedenen Cloud-Umgebungen getestet und validiert wurde.
\end{itemize} \\
\hline
ARGON & 
\begin{itemize}[leftmargin=*, nosep, before=\vspace{-0.6\baselineskip}, after=\vspace{-\baselineskip}]
