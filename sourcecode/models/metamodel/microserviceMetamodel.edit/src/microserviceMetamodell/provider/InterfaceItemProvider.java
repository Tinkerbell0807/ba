...
/**
 * This is the item provider adapter for a {@link microserviceMetamodell.Interface} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class InterfaceItemProvider 
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addBoundedContextRelationshipPropertyDescriptor(object);
	...
	/**
	 * This adds a property descriptor for the Bounded Context Relationship feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addBoundedContextRelationshipPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Interface_boundedContextRelationship_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Interface_boundedContextRelationship_feature", "_UI_Interface_type"),
				 MicroserviceMetamodellPackage.Literals.INTERFACE__BOUNDED_CONTEXT_RELATIONSHIP,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addInterfaceNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Interface_interfaceName_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Interface_interfaceName_feature", "_UI_Interface_type"),
				 MicroserviceMetamodellPackage.Literals.INTERFACE__INTERFACE_NAME,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((Interface)object).getInterfaceName();
