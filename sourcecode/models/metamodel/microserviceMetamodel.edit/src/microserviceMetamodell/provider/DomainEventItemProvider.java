...
/**
 * This is the item provider adapter for a {@link microserviceMetamodell.DomainEvent} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DomainEventItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_DomainEvent_domainModel_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_DomainEvent_domainModel_feature", "_UI_DomainEvent_type"),
				 MicroserviceMetamodellPackage.Literals.DOMAIN_EVENT__DOMAIN_MODEL,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addEventNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_DomainEvent_eventName_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_DomainEvent_eventName_feature", "_UI_DomainEvent_type"),
				 MicroserviceMetamodellPackage.Literals.DOMAIN_EVENT__EVENT_NAME,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((DomainEvent)object).getEventName();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(DomainEvent.class)) {
