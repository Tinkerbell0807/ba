...
public class TopicItemProvider 
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addTopicNameAbbreviationPropertyDescriptor(object);
	...
	/**
	 * This adds a property descriptor for the Topic Name Abbreviation feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addTopicNameAbbreviationPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Topic_topicNameAbbreviation_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Topic_topicNameAbbreviation_feature", "_UI_Topic_type"),
				 MicroserviceMetamodellPackage.Literals.TOPIC__TOPIC_NAME_ABBREVIATION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
