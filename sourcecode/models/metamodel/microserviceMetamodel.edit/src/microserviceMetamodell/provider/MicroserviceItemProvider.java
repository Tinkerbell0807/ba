...
public class MicroserviceItemProvider 
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addDeploymentConfigurationPropertyDescriptor(object);
	...
	/**
	 * This adds a property descriptor for the Deployment Configuration feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addDeploymentConfigurationPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Microservice_deploymentConfiguration_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Microservice_deploymentConfiguration_feature", "_UI_Microservice_type"),
				 MicroserviceMetamodellPackage.Literals.MICROSERVICE__DEPLOYMENT_CONFIGURATION,
				 true,
				 false,
				 true,
				 null,
