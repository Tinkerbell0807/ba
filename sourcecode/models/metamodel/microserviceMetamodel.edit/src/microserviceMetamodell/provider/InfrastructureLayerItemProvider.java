...
public class InfrastructureLayerItemProvider 
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(MicroserviceMetamodellPackage.Literals.INFRASTRUCTURE_LAYER__DEPLOYMENT_CONFIGURATIONS);
		...
		newChildDescriptors.add
			(createChildParameter
				(MicroserviceMetamodellPackage.Literals.INFRASTRUCTURE_LAYER__CLOUD_CONFIGURATION,
				 MicroserviceMetamodellFactory.eINSTANCE.createGCloudConfiguration()));

		newChildDescriptors.add
			(createChildParameter
				(MicroserviceMetamodellPackage.Literals.INFRASTRUCTURE_LAYER__DEPLOYMENT_CONFIGURATIONS,
				 MicroserviceMetamodellFactory.eINSTANCE.createDeploymentConfiguration()));
