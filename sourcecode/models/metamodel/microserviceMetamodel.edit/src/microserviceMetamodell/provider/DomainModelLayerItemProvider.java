...
/**
 * This is the item provider adapter for a {@link microserviceMetamodell.DomainModelLayer} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DomainModelLayerItemProvider 
	 ...
	 * @generated
	 */
	public DomainModelLayerItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(MicroserviceMetamodellPackage.Literals.DOMAIN_MODEL_LAYER__BOUNDED_CONTEXTS);
	...
	/**
	 * This returns DomainModelLayer.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/DomainModelLayer"));
	}
	...
	public String getText(Object object) {
		return getString("_UI_DomainModelLayer_type");
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(DomainModelLayer.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(MicroserviceMetamodellPackage.Literals.DOMAIN_MODEL_LAYER__BOUNDED_CONTEXTS,
				 MicroserviceMetamodellFactory.eINSTANCE.createBoundedContext()));

		newChildDescriptors.add
			(createChildParameter
				(MicroserviceMetamodellPackage.Literals.DOMAIN_MODEL_LAYER__DOMAIN_MODELS,
				 MicroserviceMetamodellFactory.eINSTANCE.createDomainModel()));

		newChildDescriptors.add
			(createChildParameter
				(MicroserviceMetamodellPackage.Literals.DOMAIN_MODEL_LAYER__DOMAIN_EVENTS,
				 MicroserviceMetamodellFactory.eINSTANCE.createDomainEvent()));
