...
/**
 * This is the item provider adapter for a {@link microserviceMetamodell.Module} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ModuleItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 MicroserviceMetamodellPackage.Literals.MODULE__MODULE_NAME,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((microserviceMetamodell.Module)object).getModuleName();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(microserviceMetamodell.Module.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(MicroserviceMetamodellPackage.Literals.MODULE__MODEL_ELEMENTS,
				 MicroserviceMetamodellFactory.eINSTANCE.createEntity()));
		...
		newChildDescriptors.add
			(createChildParameter
				(MicroserviceMetamodellPackage.Literals.MODULE__MODEL_ELEMENTS,
				 MicroserviceMetamodellFactory.eINSTANCE.createService()));

		newChildDescriptors.add
			(createChildParameter
				(MicroserviceMetamodellPackage.Literals.MODULE__MODEL_ELEMENTS,
				 MicroserviceMetamodellFactory.eINSTANCE.createAggregate()));

		newChildDescriptors.add
			(createChildParameter
				(MicroserviceMetamodellPackage.Literals.MODULE__MODEL_ELEMENTS,
				 MicroserviceMetamodellFactory.eINSTANCE.createFactory()));
