 ...
 * </p>
 * <ul>
 *   <li>{@link microserviceMetamodell.impl.SystemModelImpl#getWebservices <em>Webservices</em>}</li>
...
public class SystemModelImpl extends MinimalEObjectImpl.Container implements SystemModel {
	 ...
	 * @ordered
	 */
	protected EList<DomainWebservice> webservices;
	 ...
	 * @generated
	 */
	public EList<DomainWebservice> getWebservices() {
		if (webservices == null) {
			webservices = new EObjectContainmentEList<DomainWebservice>(DomainWebservice.class, this, MicroserviceMetamodellPackage.SYSTEM_MODEL__WEBSERVICES);
		}
		return webservices;
	}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case MicroserviceMetamodellPackage.SYSTEM_MODEL__WEBSERVICES:
				...
				getWebservices().addAll((Collection<? extends DomainWebservice>)newValue);
				return;
			case MicroserviceMetamodellPackage.SYSTEM_MODEL__DESCRIPTION:
